...
interface NewBuilderModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: (builder: { id: string; name: string; location: string; email?: string; phone?: string; address?: string }) => void;
  initialName?: string;
}

const NewBuilderModal: React.FC<NewBuilderModalProps> = ({ 
  isOpen, 
  onClose, 
  onSuccess, 
  initialName = '' 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.location.trim()) {
      toast.error('Builder location is required');
      return;
    }
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-xl font-semibold text-gray-900">Create New Builder</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Enter builder location"
              />
            </div>
          </div>
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            >
              {isLoading ? 'Creating...' : 'Create Builder'}
            </button>
          </div>
        </form>
      </div>
